...
| **2** | Tauri Convert polished (dialog, progress, install) | [phases/PHASE-2.md](./phases/PHASE-2.md) | **In progress** (~80%) |
| **3** | Tauri Map (MapLibre + predict + fetch/build/install) | [phases/PHASE-3.md](./phases/PHASE-3.md) | **Not started** |
