...
| **4** | Tauri Sculpt MVP → parity | [phases/PHASE-4.md](./phases/PHASE-4.md) | **MVP done** (4.1–4.4; parity 4.5 later) |
| **5** | Launcher cutover + archive egui | [phases/PHASE-5.md](./phases/PHASE-5.md) | **Done** — Tauri primary; egui legacy/hidden |
